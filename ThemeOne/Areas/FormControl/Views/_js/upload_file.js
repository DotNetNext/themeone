var $page = function () {
    ...
    function addEvent() {
        ...
        selector.$jqxFileUpload().jqxFileUpload({ accept: imageTypes, localization: jqxLocalizationUpload, width: 300, "uploadUrl": '/FormControl/UploadFile/UploadImg', autoUpload: false, fileInputName: 'img' });
